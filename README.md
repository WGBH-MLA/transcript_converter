...
The package is designed to be used by other Python modules by calling the `mmif_to_all` function.  It is also used by [clams-kitchen](https://github.com/WGBH-MLA/clams-kitchen).  A basic version of this package can be used from the CLI.
